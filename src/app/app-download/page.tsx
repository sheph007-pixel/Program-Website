    ...
    <div className="mx-auto max-w-3xl px-4 py-12 sm:py-16">
      ...
      <div className="mb-10 flex flex-col gap-4 sm:flex-row">
        <a
          ...
          className="flex-1 rounded-xl bg-black py-4 text-center font-semibold text-white shadow-md transition-all hover:bg-gray-800 hover:shadow-lg"
        >
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex-1 rounded-xl bg-[#34A853] py-4 text-center font-semibold text-white shadow-md transition-all hover:bg-[#2d9249] hover:shadow-lg"
        >
