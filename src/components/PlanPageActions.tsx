    ...
    <div className="no-print mb-6 flex flex-wrap items-center gap-2.5">
      ...
      {hasPdf && (
        <a
          ...
          download
          className="flex items-center gap-1.5 rounded-xl border border-slate-200 bg-white px-3.5 py-2 text-[13px] font-medium text-slate-600 transition-colors hover:bg-slate-50"
        >
